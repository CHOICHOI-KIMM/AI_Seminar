...
> - **RQ-M6-cρ → 검증 오라클 추가**(기본값 φ_bl 유지): `c_rho_reproduces_dowson_higginson_values` — 논문 밀도식값 재현 확인(**① 점근 1.34** \|diff\|=2e-7, **② D–H 스팟** 0.5/1.0/1.5/2.0 GPa = 1.156/1.214/1.244/1.263 정확 재현). 기존 자기충족 `2.6/2.09` 라인 제거. 인자 φ_bl↔(1−φ_bl) 정본화는 민감도+Phase 2 잔여.
