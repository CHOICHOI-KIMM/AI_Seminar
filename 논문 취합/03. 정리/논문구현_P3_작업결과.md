...
```
전체 파일: `d:/AI/AI_Seminar/Main bearing/01. 정리/논문구현_P3/micropitting-model/src/types.rs`
...
`d:/AI/AI_Seminar/Main bearing/01. 정리/논문구현_P3/D0_규약조정표.md` 작성. 핵심:
...
**파일:** `d:/AI/AI_Seminar/Main bearing/01. 정리/논문구현_P3/micropitting-model/src/m1_dry.rs` (덮어씀)
...
파일: `d:/AI/AI_Seminar/Main bearing/01. 정리/논문구현_P3/micropitting-model/src/m6_share.rs`
...
새 파일: `d:/AI/AI_Seminar/Main bearing/01. 정리/논문구현_P3/micropitting-model/tests/integration_m1m2_to_m6.rs` (공유 소스 무수정, 통합 테스트만 추가).
