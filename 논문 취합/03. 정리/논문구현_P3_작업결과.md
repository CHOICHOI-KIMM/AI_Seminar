...
| VC-M2-Comp-Amplitude(절대 상보파 진폭) | 식(28)Fig.10 / (31) 뉴턴 진폭감소 보간표 — **우리 문서 미제공(G-M2-1)** | **conditional** |
...
- (ii) 상보파 유입진폭 g×0.5 → **MISSED**(정직 보고). 진폭 절대크기를 핀할 독립 오라클 부재(G-M2-1) → 강제통과·오라클 약화·날조 없이 정직 표기.
...
### C. 잔여 (RQ/Gap)
- **G-M2-1** (차단성 conditional): 상보파 절대 유입진폭 g=0.5 — (31) Venner–Lubrecht 뉴턴 진폭감소 보간표가 우리 문서에 부재. GW1994 half-pumping+민감도[0.45,0.6](RQ-M2-comp1)로 정직 처리. VC-M2-Spot/VC-M2-Comp-Amplitude = conditional. **(31) 보간표 확보 시 절대크기 오라클 추가 → 변이(ii) CAUGHT 전환** 권고.
