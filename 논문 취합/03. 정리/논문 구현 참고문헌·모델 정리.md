...
- **참고문헌 체인**:
  | Ref | 역할 | 확보 |
  |---|---|---|
  | **(22) Stanley & Kato 1997** | FFT 기반 거친면 접촉법, 식[1] 원출처 | 필요 |
  | **(24) Kalker 1977** | 변분원리(알고리즘 이론 기반) | 필요 |
  | **(25) Tian & Bushman 1996** | 탄성-완전소성 3D 변분 스킴 | 필요 |
  | **(26) Johnson, Greenwood & Higginson 1985** | bi-sinusoidal 압력→변위해 → w(주파수응답함수) 산출 | 필요 |
  | **(21) Morales-Espejel 2010** | **3D w 전체 행렬** 명시 | **최우선** |
...
- **참고문헌 체인**:
  | Ref | 역할 | 확보 |
  |---|---|---|
  | **(27) Hooke 2006** | 롤링–슬라이딩 비뉴턴 거칠기 EHL | 필요 |
  | **(28) Hooke, Li & Morales-Espejel 2007** | 진폭감소·상보파 식[7][8] 원출처 | ✅ 보유 |
  | **(29) Greenwood & Morales-Espejel 1994** | 2성분해(특수해+상보파) 이론 | 필요 |
  | **(16) Morales-Espejel 2003** | 진폭감소법 최초(뉴턴), 식[2] 기반 | 필요 |
  | **(30) Ehret, Dowson & Taylor 1998** | Eyring 방향별 유효점도 식[6] | 필요 |
  | **(31) Venner & Lubrecht 2000** | 상보파 진폭 보간용 뉴턴 진폭감소 곡선 | 필요 |
  | **(15) Venner et al. 1997** | "amplitude reduction" 용어·방법론 기원 | 참고 |
  | **(21) Morales-Espejel 2010** | 비뉴턴 상보파 수정법·전체 통합 | **최우선** |
...
- **참고문헌 체인**:
  | Ref | 역할 | 확보 |
  |---|---|---|
  | **(16) Morales-Espejel 2003** | FFT 표면하 응력식[12][13] 원출처 | 필요 |
...
- **참고문헌 체인**:
  | Ref | 역할 | 확보 |
  |---|---|---|
  | **(13) Dang Van et al. 1989** | 다축피로 기준 원출처 식[9] | 필요 |
  | **(14) Dang Van 1993** | macro-micro 접근 | 필요 |
  | **(18) Wöhler 1870** | S–N 곡선 개념 식[10] | 참고 |
  | **(19) Shimizu et al. 2009** | **A=−43.0 MPa, B=1220 MPa (AISI 52100)** 출처 | 필요 |
  ...
  | **(32) Dang Van & Maitournam 2003** | 롤링접촉(철도) 적용례 | 참고 |
...
- **참고문헌 체인**:
  | Ref | 역할 | 확보 |
  |---|---|---|
  | **(23) Johnson, Greenwood & Poon 1972** | 하중분담 flow balance 반복법 원출처 | 필요 |
  | **(21) Morales-Espejel 2010** | 결합 모델 전체 상세·검증 | **최우선** |
...
| (20) | Palmgren 1924, VDI Z. 68 | Palmgren-Miner 누적 (손상) |

### Tier B — 구현 지원 (8편)

| Ref | 서지 | 구현 역할 |
|---|---|---|
| (18) | Wöhler 1870 | S–N 곡선 개념 식[10] |
...
**요약**: 구현에 반드시 확보할 원문 = **Tier A 17편 + Tier B (33)(37) 우선** = 약 19편. 이 중 (21)이 절대 최우선, (33)이 Dang Van gap 해소 핵심. 보유 확인된 것은 (28)뿐 → **나머지 확보가 P0의 실제 과제**.
...
> 41편 전체에 **Google Scholar 검색 링크(🔍)**를 제공하고, 웹검색으로 확인한 **직접 DOI/원문 링크**를 병기했다. DOI가 없는 오래된 문헌(1870 Wöhler, 1924 Palmgren, 1964 Dawson, 2007 Lainé-Olver 초록, 1989 Dang Van 등)은 Scholar 검색으로 접근한다.
> **집계**: 직접 DOI 35편 / URL만 2편 / Scholar만 4편. DOI·링크는 자동 조사 결과이므로 **접속 시 스팟체크 권장**. (분류·서지 상세는 §4 참조)

| Ref | 서지(약칭) | Google Scholar | 직접 링크 |
|---|---|---|---|
...
| (28) | Hooke et al. 2007, Proc. IMechE Part C 221 | [🔍](https://scholar.google.com/scholar?q=Rapid+Calculation+of+the+Pressures+and+Clearances+in+Rough+Rolling+Sliding+EHL+Contacts+Part+1+Low-Amplitude+Sinusoidal+Roughness) | [DOI](https://doi.org/10.1243/0954406JMES519) |
