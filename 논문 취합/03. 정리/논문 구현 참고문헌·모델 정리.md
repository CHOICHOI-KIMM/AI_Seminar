...
> **MD변환** 열: 로컬 MinerU 파이프라인으로 **Markdown+이미지 통합본** 생성 완료(✅). 현재 **Tier A 16/16 전부 변환**((16)2003 포함, (28)은 Part1·2 모두). 산출물: `03. 정리/<논문명>.md` + 이미지 폴더. (표 2단헤더·수식·정크제거·경로캡 자동 적용)
...
### Tier B — 구현 지원 (6편) — 보유 6/6 · MD변환 0/6
...
### Tier C — 검증·비교·현상이해 (7편) — 보유 7/7 · MD변환 0/7
