...
<!-- T70:SUMMARY -->
> **수행 중 — 30/40. 아래 값은 잠정이며 완료 시 `compare_70c.py` 가 40건으로 덮어쓴다.**

**30건 대조** (70 °C 완료 30/40). 점도 ν 294.6 → 137.2 mm²/s (-53.4%).
...
**손상비 2.61 ~ 3.03배 (평균 2.76)** · 70 °C 합격 **10/30** · 50 → 70 에서 뒤집힌 설계 **20건** (a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, b01, b02, b03, b04, b05, b06, b07, b08, b09, b10)
...
| 태그 | 프론트 # | 베어링 [t] | d [mm] | D [mm] | D_we [mm] | L_we [mm] | 세장비 | Z [개] | ΣD30_UW 50 °C | ΣD30_UW 70 °C | **손상비** | life_Sys 50 °C | life_Sys 70 °C | **판정 70 °C** |
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|:-:|
| `a01` | 1 | 13.42 | 4,069 | 4,768 | 140.1 | 334.8 | 2.390 | 91 | 0.3039 | **0.7953** | 2.62 | 97 | 37 | **불합격** |
| `a02` | 2 | 13.58 | 4,060 | 4,771 | 146.6 | 334.5 | 2.282 | 87 | 0.2775 | **0.7252** | 2.61 | 106 | 41 | **불합격** |
| `a03` | 3 | 13.63 | 4,047 | 4,763 | 136.8 | 330.5 | 2.416 | 93 | 0.2981 | **0.8037** | 2.70 | 99 | 37 | **불합격** |
| `a04` | 4 | 13.68 | 4,041 | 4,747 | 140.6 | 339.5 | 2.415 | 90 | 0.2933 | **0.7723** | 2.63 | 101 | 38 | **불합격** |
| `a05` | 5 | 13.83 | 4,009 | 4,730 | 140.2 | 336.7 | 2.402 | 90 | 0.2788 | **0.7529** | 2.70 | 106 | 39 | **불합격** |
| `a06` | 6 | 13.97 | 3,982 | 4,706 | 147.8 | 343.0 | 2.321 | 85 | 0.2595 | **0.6885** | 2.65 | 114 | 43 | **불합격** |
| `a07` | 7 | 14.17 | 3,978 | 4,706 | 147.7 | 345.8 | 2.341 | 85 | 0.2530 | **0.6736** | 2.66 | 117 | 44 | **불합격** |
| `a08` | 8 | 14.20 | 3,968 | 4,710 | 141.0 | 337.0 | 2.390 | 89 | 0.2655 | **0.7290** | 2.75 | 111 | 40 | **불합격** |
| `a09` | 9 | 14.39 | 3,962 | 4,701 | 147.8 | 346.8 | 2.346 | 84 | 0.2460 | **0.6636** | 2.70 | 120 | 44 | **불합격** |
| `a10` | 10 | 14.41 | 3,935 | 4,669 | 147.4 | 352.0 | 2.388 | 84 | 0.2482 | **0.6661** | 2.68 | 119 | 44 | **불합격** |
| `a55` | 55 | 24.53 | 3,652 | 4,689 | 179.3 | 430.3 | 2.400 | 67 | 0.1158 | **0.3391** | 2.93 | 253 | 86 | 합격 |
| `a56` | 56 | 24.76 | 3,640 | 4,676 | 184.3 | 437.1 | 2.372 | 65 | 0.1045 | **0.3087** | 2.95 | 280 | 94 | 합격 |
| `a57` | 57 | 24.77 | 3,628 | 4,665 | 184.6 | 437.9 | 2.372 | 65 | 0.1029 | **0.3050** | 2.96 | 284 | 95 | 합격 |
| `a58` | 58 | 25.85 | 3,581 | 4,644 | 188.0 | 449.5 | 2.391 | 63 | 0.0944 | **0.2831** | 3.00 | 309 | 103 | 합격 |
| `a59` | 59 | 25.99 | 3,721 | 4,797 | 183.7 | 430.3 | 2.342 | 67 | 0.1192 | **0.3401** | 2.85 | 246 | 86 | 합격 |
| `a60` | 60 | 26.91 | 3,679 | 4,768 | 184.6 | 442.7 | 2.398 | 66 | 0.1108 | **0.3206** | 2.89 | 264 | 91 | 합격 |
| `a61` | 61 | 29.26 | 3,377 | 4,594 | 229.2 | 466.0 | 2.033 | 50 | 0.0634 | **0.1920** | 3.03 | 463 | 152 | 합격 |
| `a62` | 62 | 29.31 | 3,371 | 4,590 | 229.7 | 466.4 | 2.030 | 50 | 0.0625 | **0.1897** | 3.03 | 470 | 154 | 합격 |
| `a63` | 63 | 31.23 | 3,915 | 5,068 | 198.9 | 458.8 | 2.307 | 65 | 0.0977 | **0.2698** | 2.76 | 296 | 106 | 합격 |
| `a64` | 64 | 33.05 | 3,814 | 5,000 | 198.9 | 478.1 | 2.404 | 64 | 0.0901 | **0.2548** | 2.83 | 320 | 113 | 합격 |
| `b01` | 1 | 15.91 | 4,086 | 4,891 | 146.8 | 335.9 | 2.288 | 88 | 0.3210 | **0.8432** | 2.63 | 92 | 35 | **불합격** |
| `b02` | 2 | 15.97 | 4,046 | 4,846 | 147.8 | 342.3 | 2.316 | 87 | 0.2948 | **0.7871** | 2.67 | 100 | 37 | **불합격** |
| `b03` | 3 | 16.57 | 4,023 | 4,813 | 165.5 | 368.4 | 2.226 | 77 | 0.2154 | **0.5692** | 2.64 | 136 | 51 | **불합격** |
| `b04` | 4 | 16.58 | 4,016 | 4,807 | 160.6 | 367.4 | 2.288 | 79 | 0.2232 | **0.5968** | 2.67 | 131 | 49 | **불합격** |
| `b05` | 5 | 16.66 | 3,976 | 4,775 | 163.7 | 368.7 | 2.252 | 77 | 0.2154 | **0.5783** | 2.68 | 136 | 50 | **불합격** |
| `b06` | 6 | 16.86 | 3,944 | 4,734 | 158.0 | 379.6 | 2.402 | 79 | 0.2252 | **0.6058** | 2.69 | 130 | 48 | **불합격** |
| `b07` | 7 | 17.14 | 3,936 | 4,782 | 160.9 | 356.5 | 2.216 | 78 | 0.2293 | **0.6240** | 2.72 | 129 | 47 | **불합격** |
| `b08` | 8 | 17.32 | 3,917 | 4,769 | 158.4 | 358.0 | 2.260 | 79 | 0.2363 | **0.6447** | 2.73 | 125 | 46 | **불합격** |
| `b09` | 9 | 17.51 | 3,909 | 4,743 | 153.9 | 369.8 | 2.403 | 81 | 0.2246 | **0.6235** | 2.78 | 131 | 47 | **불합격** |
| `b10` | 10 | 17.64 | 3,861 | 4,690 | 159.5 | 381.8 | 2.394 | 77 | 0.2020 | **0.5635** | 2.79 | 145 | 52 | **불합격** |
<!-- /T70:TABLE -->
...
프론트 순번(1 = 베어링 최경량 → 64 = 총질량 최경량)을 따라 치수가 어떻게 움직이는지 본다.

| 변수 | 상관 (1~64) | **상관 (1~62)** | 방향 | 상위 16건이 있는 곳 | 상한이 자르는 쪽 |
|---|--:|--:|---|---|---|
| `d` (보어) | −0.768 | **−0.865** | 감소 | 머리 15 · 꼬리 1 | **베어링 경량(머리)** |
| `D` (외경) | −0.160 | **−0.415** | 감소 | 머리 10 · 꼬리 6 | **머리 + 꼬리 양쪽** |
| `D_we` | +0.885 | **+0.887** | 증가 | 중간 7 · 꼬리 9 | **총질량 경량(꼬리)** |
| `L_we` | +0.968 | **+0.966** | 증가 | 중간 3 · 꼬리 13 | **꼬리** |

**베어링 경량안은 `d`·`D` 가 크고 `D_we`·`L_we` 가 작다. 총질량 경량안은 그 반대다.** 롤러를 줄이고 궤도를 크게 벌리면 베어링이 가벼워지고, 롤러를 키우고 스팬을 좁히면 샤프트가 짧아져 총질량이 가벼워진다.

**따라서 제작 가능 영역은 양 꼬리를 잘라낸 중간에 형성된다.** 각 변수의 중앙값을 상한으로 걸어 보면 그대로 나타난다.

| 상한 (예시 = 중앙값) | 생존 | 남는 순번 | 머리(1~16) 생존 |
|---|--:|---|--:|
| `d` ≤ 3,670.5 | 32 | 28 ~ 62 | **0** |
| `D` ≤ 4,580.0 | 32 | 20 ~ 54 | **0** |
| `D_we` ≤ 179.6 | 32 | 1 ~ 55 | 16 |
| `L_we` ≤ 396.8 | 32 | 1 ~ 32 | 16 |
| **네 개 동시(AND)** | **4** | **28 ~ 31** | 0 |

> **앞선 서술을 정정한다.** 이 자리에 "네 제약이 같은 방향으로 작동해 총질량-최소 쪽 꼬리만 자른다"고 적었으나 **틀렸다.** 근거로 삼았던 "단독 적용 시 생존이 16/32/48 로 일치한다"는 관찰은 **컷라인을 백분위로 잡은 데서 오는 항등식**이다 — p25 로 자르면 방향과 무관하게 25% 가 남는다. 방향은 상관계수로 봐야 했다.
...
| 8 | ~~프론트가 피로를 만족하는지~~ → **확인: 40건 전원 합격**(§6-11.6). 최소 여유 `b01` **1.56배** · `D_we`·베어링질량과 손상의 상관 −0.95. 다만 **양 끝 20건씩만** 검토했다 | ✅ 종결 |
