...
<!-- T70:SUMMARY -->
> **수행 중 — 23/40. 아래 값은 잠정이며 완료 시 `compare_70c.py` 가 40건으로 덮어쓴다.**
...
<!-- T70:TABLE -->
| 태그 | 프론트 # | 베어링 [t] | D_we [mm] | ΣD30_UW 50 °C | ΣD30_UW 70 °C | **손상비** | life_Sys 50 °C | life_Sys 70 °C | **판정 70 °C** |
|---|--:|--:|--:|--:|--:|--:|--:|--:|:-:|
| `a01` | 1 | 13.42 | 140.1 | 0.3039 | **0.7953** | 2.62 | 97 | 37 | **불합격** |
| `a02` | 2 | 13.58 | 146.6 | 0.2775 | **0.7252** | 2.61 | 106 | 41 | **불합격** |
| `a03` | 3 | 13.63 | 136.8 | 0.2981 | **0.8037** | 2.70 | 99 | 37 | **불합격** |
| `a04` | 4 | 13.68 | 140.6 | 0.2933 | **0.7723** | 2.63 | 101 | 38 | **불합격** |
| `a05` | 5 | 13.83 | 140.2 | 0.2788 | **0.7529** | 2.70 | 106 | 39 | **불합격** |
| `a06` | 6 | 13.97 | 147.8 | 0.2595 | **0.6885** | 2.65 | 114 | 43 | **불합격** |
| `a07` | 7 | 14.17 | 147.7 | 0.2530 | **0.6736** | 2.66 | 117 | 44 | **불합격** |
| `a08` | 8 | 14.20 | 141.0 | 0.2655 | **0.7290** | 2.75 | 111 | 40 | **불합격** |
| `a09` | 9 | 14.39 | 147.8 | 0.2460 | **0.6636** | 2.70 | 120 | 44 | **불합격** |
| `a10` | 10 | 14.41 | 147.4 | 0.2482 | **0.6661** | 2.68 | 119 | 44 | **불합격** |
| `a55` | 55 | 24.53 | 179.3 | 0.1158 | **0.3391** | 2.93 | 253 | 86 | 합격 |
| `a56` | 56 | 24.76 | 184.3 | 0.1045 | **0.3087** | 2.95 | 280 | 94 | 합격 |
| `a57` | 57 | 24.77 | 184.6 | 0.1029 | **0.3050** | 2.96 | 284 | 95 | 합격 |
| `a58` | 58 | 25.85 | 188.0 | 0.0944 | **0.2831** | 3.00 | 309 | 103 | 합격 |
| `a59` | 59 | 25.99 | 183.7 | 0.1192 | **0.3401** | 2.85 | 246 | 86 | 합격 |
| `a60` | 60 | 26.91 | 184.6 | 0.1108 | **0.3206** | 2.89 | 264 | 91 | 합격 |
| `a61` | 61 | 29.26 | 229.2 | 0.0634 | **0.1920** | 3.03 | 463 | 152 | 합격 |
| `a62` | 62 | 29.31 | 229.7 | 0.0625 | **0.1897** | 3.03 | 470 | 154 | 합격 |
| `a63` | 63 | 31.23 | 198.9 | 0.0977 | **0.2698** | 2.76 | 296 | 106 | 합격 |
| `a64` | 64 | 33.05 | 198.9 | 0.0901 | **0.2548** | 2.83 | 320 | 113 | 합격 |
| `b01` | 1 | 15.91 | 146.8 | 0.3210 | **0.8432** | 2.63 | 92 | 35 | **불합격** |
| `b02` | 2 | 15.97 | 147.8 | 0.2948 | **0.7871** | 2.67 | 100 | 37 | **불합격** |
| `b03` | 3 | 16.57 | 165.5 | 0.2154 | **0.5692** | 2.64 | 136 | 51 | **불합격** |
