...
> 작성 260727~ · **현재 판 R7 (260730)** · 선행 문서: `DLC기반_피로해석_DLC별해석.md`(부록 1~5), `DLC기반_피로해석_프로세스_v1.md`
> 전체 개정 경위는 문서 최하단 **[개정 이력](#개정-이력)** 참조 — 번복·무효화 21건을 R0~R7 로 정리했다.
...
| P2 참값 편향 검증 (Step 4) | ⏸ 보류 | #1 · 상위 50 DLC · dt=0.1 · 약 12.7시간 (§8-3.4) |
| P3 — 최종 확정 | ⬜ 미착수 | |
...
| 제약 | 기준 | 최경량 #1 | 최장수명 #9 |
|---|---|---:|---:|
| 극한 σ_max | < 2,100 MPa | **2,090.5** | 2,082.9 |
| 피로 Σ D30_UW | ≤ 0.5 | **0.1173** | **0.0415** |
| 질량 | (기준선 54.4 t) | **121.5 t** (2.23배) | 128.0 t |
