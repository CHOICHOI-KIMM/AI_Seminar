...
| # | OD [mm] | 내경 [mm] | 두께 [mm] | **베어링** [t] | 샤프트 [t] | **총질량** [t] | Δ총질량 | σ [MPa] | 판정 |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|:-:|
| 1 | 4,069 | 3,602 → **3,835** | 117.0 | **13.42** | 142.6 → 73.6 | **100.5** | -69.0 | 2,098 → **2,194** | ❌ |
| 2 | 4,060 | 3,594 → **3,825** | 117.5 | **13.58** | 142.0 → 73.8 | **101.0** | -68.2 | 2,098 → **2,187** | ❌ |
| 3 | 4,047 | 3,583 → **3,810** | 118.5 | **13.63** | 141.0 → 74.1 | **101.4** | -66.8 | 2,099 → **2,193** | ❌ |
| 4 | 4,041 | 3,578 → **3,803** | 119.0 | **13.68** | 140.5 → 74.3 | **101.7** | -66.1 | 2,098 → **2,193** | ❌ |
| 5 | 4,009 | 3,549 → **3,767** | 121.0 | **13.83** | 138.4 → 74.9 | **102.6** | -63.5 | 2,100 → **2,191** | ❌ |
| 6 | 3,982 | 3,525 → **3,736** | 123.0 | **13.97** | 136.6 → 75.6 | **103.5** | -61.0 | 2,100 → **2,186** | ❌ |
| 7 | 3,978 | 3,522 → **3,731** | 123.5 | **14.17** | 136.2 → 75.8 | **104.2** | -60.4 | 2,095 → **2,182** | ❌ |
| 8 | 3,968 | 3,513 → **3,720** | 124.0 | **14.20** | 135.5 → 75.9 | **104.3** | -59.6 | 2,100 → **2,186** | ❌ |
| 9 | 3,962 | 3,508 → **3,713** | 124.5 | **14.39** | 135.0 → 76.1 | **104.9** | -58.9 | 2,099 → **2,184** | ❌ |
| 10 | 3,935 | 3,484 → **3,682** | 126.5 | **14.41** | 133.2 → 76.7 | **105.6** | -56.5 | 2,100 → **2,185** | ❌ |
| 11 | 3,911 | 3,462 → **3,655** | 128.0 | **14.65** | 131.8 → 77.1 | **106.4** | -54.7 | 2,096 → **2,180** | ❌ |
| 12 | 3,902 | 3,454 → **3,644** | 129.0 | **14.74** | 131.2 → 77.5 | **107.0** | -53.7 | 2,099 → **2,184** | ❌ |
| 13 | 3,892 | 3,446 → **3,633** | 129.5 | **14.97** | 130.3 → 77.6 | **107.5** | -52.7 | 2,099 → **2,176** | ❌ |
| 14 | 3,891 | 3,445 → **3,631** | 130.0 | **14.98** | 130.3 → 77.9 | **107.8** | -52.4 | 2,100 → **2,179** | ❌ |
| 15 | 3,875 | 3,431 → **3,613** | 131.0 | **14.99** | 129.2 → 78.1 | **108.1** | -51.0 | 2,099 → **2,178** | ❌ |
| 16 | 3,855 | 3,413 → **3,590** | 132.5 | **15.13** | 127.9 → 78.6 | **108.8** | -49.4 | 2,099 → **2,169** | ❌ |
| 17 | 3,844 | 3,403 → **3,577** | 133.5 | **15.28** | 127.3 → 78.9 | **109.5** | -48.4 | 2,096 → **2,168** | ❌ |
| 18 | 3,821 | 3,383 → **3,550** | 135.5 | **15.48** | 125.6 → 79.5 | **110.5** | -46.1 | 2,095 → **2,166** | ❌ |
| 19 | 3,810 | 3,373 → **3,537** | 136.5 | **15.67** | 125.0 → 79.9 | **111.2** | -45.1 | 2,098 → **2,166** | ❌ |
| 20 | 3,788 | 3,354 → **3,512** | 138.0 | **15.68** | 123.4 → 80.2 | **111.6** | -43.2 | 2,100 → **2,172** | ❌ |
| 21 | 3,777 | 3,344 → **3,499** | 139.0 | **15.88** | 122.8 → 80.5 | **112.3** | -42.2 | 2,095 → **2,166** | ❌ |
| 22 | 3,765 | 3,333 → **3,485** | 140.0 | **15.92** | 122.1 → 80.8 | **112.7** | -41.3 | 2,100 → **2,165** | ❌ |
| 23 | 3,759 | 3,328 → **3,477** | 141.0 | **15.98** | 121.6 → 81.3 | **113.2** | -40.4 | 2,100 → **2,165** | ❌ |
| 24 | 3,730 | 3,302 → **3,443** | 143.5 | **16.25** | 119.8 → 82.0 | **114.5** | -37.9 | 2,099 → **2,164** | ❌ |
| 25 | 3,725 | 3,298 → **3,437** | 144.0 | **16.37** | 119.4 → 82.1 | **114.9** | -37.3 | 2,100 → **2,158** | ❌ |
| 26 | 3,715 | 3,289 → **3,425** | 145.0 | **16.51** | 118.8 → 82.5 | **115.5** | -36.4 | 2,098 → **2,162** | ❌ |
| 27 | 3,689 | 3,266 → **3,395** | 147.0 | **17.01** | 117.1 → 82.9 | **116.9** | -34.2 | 2,093 → **2,154** | ❌ |
| 28 | 3,665 | 3,245 → **3,366** | 149.5 | **17.12** | 115.6 → 83.7 | **118.0** | -31.9 | 2,099 → **2,146** | ❌ |
| 29 | 3,657 | 3,238 → **3,356** | 150.5 | **17.27** | 115.0 → 84.1 | **118.6** | -31.0 | 2,100 → **2,146** | ❌ |
| 30 | 3,642 | 3,224 → **3,338** | 152.0 | **17.40** | 114.3 → 84.5 | **119.3** | -29.8 | 2,097 → **2,152** | ❌ |
| 31 | 3,638 | 3,221 → **3,333** | 152.5 | **17.50** | 113.9 → 84.7 | **119.7** | -29.2 | 2,097 → **2,151** | ❌ |
| 32 | 3,598 | 3,185 → **3,285** | 156.5 | **17.88** | 111.5 → 85.8 | **121.5** | -25.8 | 2,100 → **2,140** | ❌ |
| 33 | 3,555 | 3,147 → **3,233** | 161.0 | **18.54** | 108.9 → 87.0 | **124.1** | -21.8 | 2,097 → **2,132** | ❌ |
| 34 | 3,542 | 3,136 → **3,217** | 162.5 | **18.61** | 108.0 → 87.5 | **124.7** | -20.5 | 2,099 → **2,133** | ❌ |
| 35 | 3,533 | 3,128 → **3,206** | 163.5 | **18.62** | 107.4 → 87.7 | **125.0** | -19.7 | 2,100 → **2,132** | ❌ |
| 36 | 3,523 | 3,119 → **3,193** | 165.0 | **18.90** | 106.9 → 88.3 | **126.1** | -18.6 | 2,098 → **2,128** | ❌ |
| 37 | 3,506 | 3,104 → **3,172** | 167.0 | **18.97** | 105.8 → 88.8 | **126.7** | -17.0 | 2,099 → **2,128** | ❌ |
| 38 | 3,463 | 3,066 → **3,119** | 172.0 | **19.64** | 103.2 → 90.2 | **129.4** | -13.1 | 2,098 → **2,122** | ❌ |
| 39 | 3,442 | 3,047 → **3,093** | 174.5 | **20.05** | 102.1 → 90.8 | **130.9** | -11.2 | 2,099 → **2,120** | ❌ |
| 40 | 3,437 | 3,043 → **3,086** | 175.5 | **20.10** | 101.7 → 91.2 | **131.4** | -10.5 | 2,100 → **2,119** | ❌ |
| 41 | 3,420 | 3,028 → **3,065** | 177.5 | **20.54** | 100.6 → 91.7 | **132.8** | -9.0 | 2,100 → **2,119** | ❌ |
| 42 | 3,399 | 3,009 → **3,038** | 180.5 | **21.08** | 99.5 → 92.5 | **134.7** | -7.0 | 2,098 → **2,111** | ❌ |
| 43 | 3,676 | 3,254 → **3,379** | 148.5 | **21.51** | 98.5 → 70.6 | **113.6** | -27.9 | 2,098 → **2,140** | ❌ |
| 44 | 3,497 | 3,096 → **3,161** | 168.0 | **21.58** | 97.2 → 82.2 | **125.4** | -14.9 | 2,099 → **2,126** | ❌ |
| 45 | 3,474 | 3,075 → **3,133** | 170.5 | **21.92** | 96.0 → 82.8 | **126.7** | -13.2 | 2,098 → **2,123** | ❌ |
| 46 | 3,614 | 3,199 → **3,304** | 155.0 | **22.31** | 95.3 → 72.3 | **116.9** | -23.0 | 2,099 → **2,134** | ❌ |
| 47 | 3,610 | 3,196 → **3,300** | 155.0 | **22.45** | 94.9 → 72.2 | **117.1** | -22.8 | 2,098 → **2,133** | ❌ |
| 48 | 3,444 | 3,049 → **3,095** | 174.5 | **22.59** | 94.3 → 83.9 | **129.1** | -10.4 | 2,098 → **2,117** | ❌ |
| 49 | 3,438 | 3,044 → **3,087** | 175.5 | **22.62** | 93.9 → 84.2 | **129.4** | -9.7 | 2,100 → **2,116** | ❌ |
| 50 | 3,424 | 3,031 → **3,070** | 177.0 | **22.79** | 93.2 → 84.5 | **130.1** | -8.7 | 2,097 → **2,113** | ❌ |
| 51 | 3,417 | 3,025 → **3,061** | 178.0 | **22.83** | 92.8 → 84.8 | **130.4** | -8.1 | 2,099 → **2,113** | ❌ |
| 52 | 3,398 | 3,008 → **3,037** | 180.5 | **23.11** | 91.8 → 85.4 | **131.6** | -6.4 | 2,099 → **2,111** | ❌ |
| 53 | 3,376 | 2,989 → **3,009** | 183.5 | **23.72** | 90.5 → 86.1 | **133.6** | -4.4 | 2,098 → **2,106** | ❌ |
| 54 | 3,359 | 2,974 → **2,987** | 186.0 | **24.12** | 89.6 → 86.8 | **135.0** | -2.8 | 2,095 → **2,101** | ❌ |
| 55 | 3,652 | 3,233 → **3,350** | 151.0 | **24.53** | 88.4 → 64.8 | **113.8** | -23.6 | 2,096 → **2,136** | ❌ |
| 56 | 3,640 | 3,222 → **3,336** | 152.0 | **24.76** | 87.9 → 65.0 | **114.5** | -22.9 | 2,100 → **2,139** | ❌ |
| 57 | 3,628 | 3,212 → **3,321** | 153.5 | **24.77** | 87.2 → 65.3 | **114.9** | -21.8 | 2,099 → **2,137** | ❌ |
| 58 | 3,581 | 3,170 → **3,264** | 158.5 | **25.85** | 85.0 → 66.5 | **118.2** | -18.5 | 2,096 → **2,129** | ❌ |
| 59 | 3,721 | 3,294 → **3,433** | 144.0 | **25.99** | 82.6 → 56.8 | **108.8** | -25.8 | 2,100 → **2,139** | ❌ |
| 60 | 3,679 | 3,257 → **3,383** | 148.0 | **26.91** | 80.7 → 57.6 | **111.4** | -23.1 | 2,099 → **2,136** | ❌ |
| 61 | 3,377 | 2,990 → **3,010** | 183.5 | **29.26** | 75.5 → 71.8 | **130.3** | -3.7 | 2,100 → **2,106** | ❌ |
| 62 | 3,371 | 2,984 → **3,002** | 184.5 | **29.31** | 75.3 → 72.0 | **130.6** | -3.3 | 2,098 → **2,104** | ❌ |
| 63 | 3,915 | 3,466 → **3,659** | 128.0 | **31.23** | 71.1 → 41.6 | **104.0** | -29.5 | 2,100 → **2,134** | ❌ |
| 64 | 3,814 | 3,377 → **3,542** | 136.0 | **33.05** | 67.4 → 42.9 | **109.0** | -24.5 | 2,093 → **2,124** | ❌ |
<!-- /A7:FRONT52 -->
...
> **아직 채택하지 않는다.** ⑴ 안전계수를 얹지 않은 **한계값**이다 — 피로 5.0 을
> 정확히 만족하는 지점이라 여유가 0 이다 ⑵ `ID_OVER_OD = 0.88543` 은 §4-3 종속
> 사슬의 뿌리라 바꾸면 **P1 극한 응력·S3 프론트·부록 6 전체를 다시 계산**해야
> 한다 ⑶ §7-6.7.2 의 미검토 셋(국부 좌굴·끼워맞춤 압력·국부 구조)이 그대로
> 남아 있다. 안전계수와 채택 여부는 별도 검토로 넘긴다.
