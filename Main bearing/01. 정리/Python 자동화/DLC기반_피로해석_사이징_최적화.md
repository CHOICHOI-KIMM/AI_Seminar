...
| 설계               | 조건         |         ΣD30 UW | ΣD30 DW | 수명 UW | 수명 DW | **수명 Sys** |        기준 대비 |
| ------------------ | ------------ | ---------------: | -------: | ------: | ------: | -----------------: | ---------------: |
| **`#1`**   | 오프셋만     |           0.1623 |   0.0070 |   184.8 | 4,306.9 |  **180.2년** |               — |
|                    | + 비대칭 DIN |           0.2525 |   0.0125 |   118.8 | 2,393.1 |  **115.3년** | **−36 %** |
| **`#103`** | 오프셋만     |           0.2269 |   0.0108 |   132.2 | 2,773.3 |  **128.5년** |               — |
|                    | + 비대칭 DIN |           0.3425 |   0.0188 |    87.6 | 1,593.9 |   **84.7년** | **−34 %** |
| **`#210`** | 오프셋만     |           0.3778 |   0.0171 |    79.4 | 1,755.5 |   **77.3년** |               — |
|                    | + 비대칭 DIN | **0.6190** |   0.0325 |    48.5 |   923.5 |   **46.9년** | **−39 %** |
...
판정 기준은 **`ΣD30` ≤ 0.5**(30년 설계수명 · 안전여유 2배)다.

| 설계     | ΣD30 UW (오프셋만) | ΣD30 UW (+ 비대칭) |          기준 0.5 대비 |          판정          |
| -------- | ------------------: | ------------------: | ---------------------: | :---------------------: |
| `#1`   |              0.1623 |              0.2525 |            50.5 % 사용 |     ✅ 여유 1.98배     |
| `#103` |              0.2269 |              0.3425 |            68.5 % 사용 |     ✅ 여유 1.46배     |
| `#210` |              0.3778 |    **0.6190** | **123.8 % 사용** | ❌**위반 +0.119** |

**`#210` 은 기준을 넘는다 — 적용 불가다.** 셋 중 가장 작은 베어링(`L_we` 347.6 · `D_we` 170.0)이라 오프셋만으로도 이미 0.3778(75.6 %)로 여유가 얇았고, 그 위에 프로파일이 얹혔다.
