...
#### 7-6.7.5 종속변수 반영 — 두 가지 형태

| 형태 | 식 | 오차 | 비고 |
|---|---|--:|---|
| **정확형** | `ID = (OD⁴ − 32·W·OD/π)^¼` · `W = 1.347×10⁹ mm³` | ±1.2% | 물리적으로 정확 · `sizing_geom` 의 `ID = r·OD` 보다 식이 복잡 |
| 근사형 | `t = 6.32×10¹⁰ · OD^−2.42` | ±3% | 기존 구조에 넣기 쉬우나 **OD 3,287 ~ 4,086 mm 밖에서는 보장 없음** |
