...
| **P2 Phase 3** — 베어링 최경량 피로 |  ✅**완료**  | **6건(C·D) 전원 합격** · 여유 1.7~4.4배 · 33.5분 (§8-5.7)                          |
...
| 부록 6 S4~S5                             |     ⬜ 미착수     | 프론트 대표점 P2 본해석 → 엑셀 총망라                                   |
| P3 — 최종 확정                            |     ⬜ 미착수     |                                                                                              |
...
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| 1 | 4,500 | 4,134 | 4,857 | 423 | 410 | 345 | 19 | 140 | 325 | 2.321 | 1.0 | 6.0 | 92 | 6.523 | **13.76** | 147.0 | **174.5** | 2,086.4 |
| 2 | 4,500 | 4,123 | 4,867 | 423 | 410 | 345 | 15 | 170 | 325 | 1.912 | 1.0 | 6.0 | 76 | 6.180 | **13.79** | 146.2 | **173.8** | 2,097.9 |
| 3 | 4,500 | 4,094 | 4,896 | 423 | 410 | 345 | 15 | 200 | 325 | 1.625 | 1.0 | 6.0 | 65 | 6.180 | **14.65** | 144.2 | **173.5** | 2,095.8 |
| 4 | 4,500 | 4,059 | 4,932 | 423 | 410 | 345 | 31 | 170 | 325 | 1.912 | 1.0 | 5.5 | 76 | 7.180 | **16.42** | 130.8 | **163.7** | 2,096.7 |
| 5 | 4,500 | 4,033 | 4,958 | 423 | 410 | 345 | 31 | 200 | 325 | 1.625 | 1.0 | 5.5 | 65 | 7.181 | **17.07** | 129.1 | **163.3** | 2,093.9 |
| 6 | 4,200 | 3,774 | 4,614 | 521 | 504 | 425 | 15 | 170 | 400 | 2.353 | 1.0 | 5.5 | 71 | 5.602 | **18.23** | 113.1 | **149.5** | 2,094.8 |
| 7 | 4,200 | 3,709 | 4,679 | 521 | 504 | 425 | 27 | 170 | 400 | 2.353 | 1.0 | 5.0 | 71 | 6.119 | **21.42** | 100.1 | **143.0** | 2,092.8 |
| 8 | 4,500 | 4,009 | 4,979 | 521 | 504 | 425 | 27 | 170 | 400 | 2.353 | 1.0 | 4.0 | 76 | 5.271 | **22.95** | 95.7 | **141.6** | 2,097.4 |
| 9 | 3,900 | 3,396 | 4,390 | 619 | 599 | 505 | 15 | 200 | 475 | 2.375 | 1.0 | 5.5 | 56 | 5.526 | **23.77** | 91.6 | **139.1** | 2,098.3 |
| 10 | 3,900 | 3,315 | 4,471 | 619 | 599 | 505 | 23 | 230 | 475 | 2.065 | 1.0 | 5.0 | 49 | 5.639 | **27.65** | 80.0 | **135.3** | 2,095.5 |
...
##### 8-5.7.1 집합 C — `z1 = 1.0` (§8-4.4.1 상위 3)
...
##### 8-5.7.2 집합 D — `z1 ≥ 1.5` (§8-4.4.2 상위 3)
...
| -------------- | ------------------- | ---------------------------------- | ------------------------- | ----: | -------------------------------------------------------- |
| **z1**   | 0.3 ~ 1.0 (0.1)     | **{1.0, 1.5} m**             | `Choice`                |     2 | 집합 C·D 구분과 일치(§8-5.7)                           |
...
**근거는 실측이다.** 지금까지 피로를 돌린 30건이 **전원 합격**했다.
...
특히 Phase 3 은 `D_we` 140 까지 내려간 극단 설계였는데도 최소 여유가 1.73배였다(§8-5.7.3). **응력 제약을 만족하면 피로는 따라온다**는 것이 현재 근거다.

따라서 **σ 제약만으로 최적화하고, 최종 프론트에만 P2 본해석을 건다**(S4). 탈락이 나오면 그때 대리모델을 루프에 넣어 재수행한다.

> **한계** — 이는 30건의 경험칙이지 증명이 아니다. Phase 3 의 1.73배는 넉넉하지 않고, 최적화가 그보다 더 극단으로 갈 수 있다. S4 에서 반드시 확인한다.
...
| 세대 | 1 | 5 | 25 | 50 | 75 | 100 | 125 | 150 |
|---|--:|--:|--:|--:|--:|--:|--:|--:|
| HV | 2,120.5 | 2,564.6 | 2,849.6 | 2,890.0 | 2,899.6 | 2,925.9 | 2,928.2 | **2,929.5** |
| 최소 베어링 [t] | 19.306 | 16.351 | 13.904 | 13.694 | 13.694 | 13.423 | 13.423 | 13.423 |

**HV 가 0.5 이상 오른 마지막 세대는 97 이다.** 50 ~ 97세대 구간은 HV 증분이 한 자릿수로 떨어져 정체처럼 보였지만, **97 ~ 104세대에서 최소 베어링질량이 13.694 → 13.423 t 로 갱신**되며 프론트가 통째로 안쪽으로 이동했다(프론트 점수가 73 → 65 로 줄어든 것이 그 증거 — 새 해가 기존 점들을 지배했다).
...
> **S4 가 필수다.** 최경량 5건의 `D_we` 가 136.8 ~ 146.6 mm 로, P2 Phase 3 에서 **최소 여유 1.73배**를 기록한 `D_we` 140 설계와 같은 극단 영역이다(§8-5.7.3). §6-7 이 피로를 루프에서 뺀 근거는 "30건 전원 합격"이라는 경험칙이었고 그 한계를 명시해 두었다 — 프론트 대표점에 P2 본해석을 걸어 확인해야 한다.
...
| # | D_pw [mm] | d [mm] | D [mm] | T [mm] | B [mm] | C [mm] | α [°] | D_we [mm] | L_we [mm] | 세장비 | z1 [m] | z2 [m] | Z [개] | L_eff [m] | **베어링** [t] | 샤프트 [t] | **합계** [t] | σ_max [MPa] |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| 1 | 4,423 | 4,069 | 4,768 | 436 | 422 | 356 | 15 | 140.1 | 334.8 | 2.390 | 1.0 | 6.0 | 91 | 6.159 | **13.42** | 142.6 | **169.5** | 2,098.3 |
| 2 | 4,420 | 4,060 | 4,771 | 436 | 422 | 356 | 15 | 146.6 | 334.5 | 2.282 | 1.0 | 6.0 | 87 | 6.158 | **13.58** | 142.0 | **169.2** | 2,097.5 |
| 3 | 4,410 | 4,047 | 4,763 | 430 | 417 | 351 | 18 | 136.8 | 330.5 | 2.416 | 1.0 | 6.0 | 93 | 6.406 | **13.63** | 141.0 | **168.2** | 2,099.0 |
| 4 | 4,399 | 4,041 | 4,747 | 442 | 428 | 361 | 15 | 140.6 | 339.5 | 2.415 | 1.0 | 6.0 | 90 | 6.152 | **13.68** | 140.5 | **167.8** | 2,097.9 |
| 5 | 4,374 | 4,009 | 4,730 | 438 | 424 | 358 | 17 | 140.2 | 336.7 | 2.402 | 1.0 | 6.0 | 90 | 6.311 | **13.83** | 138.4 | **166.1** | 2,099.9 |
| 6 | 4,349 | 3,982 | 4,706 | 447 | 432 | 365 | 15 | 147.8 | 343.0 | 2.321 | 1.0 | 6.0 | 85 | 6.140 | **13.97** | 136.6 | **164.6** | 2,099.9 |
| 7 | 4,347 | 3,978 | 4,706 | 450 | 436 | 368 | 15 | 147.7 | 345.8 | 2.341 | 1.0 | 6.0 | 85 | 6.139 | **14.17** | 136.2 | **164.5** | 2,095.1 |
| 8 | 4,344 | 3,968 | 4,710 | 439 | 425 | 358 | 19 | 141.0 | 337.0 | 2.390 | 1.0 | 6.0 | 89 | 6.470 | **14.20** | 135.5 | **163.9** | 2,099.7 |
| 9 | 4,336 | 3,962 | 4,701 | 452 | 437 | 369 | 16 | 147.8 | 346.8 | 2.346 | 1.0 | 6.0 | 84 | 6.218 | **14.39** | 135.0 | **163.8** | 2,099.3 |
| 10 | 4,307 | 3,935 | 4,669 | 458 | 444 | 374 | 15 | 147.4 | 352.0 | 2.388 | 1.0 | 6.0 | 84 | 6.128 | **14.41** | 133.2 | **162.1** | 2,099.6 |

**총질량 최경량 10건** (프론트 #55 ~ #64) — 프론트 꼬리다. 아래로 갈수록 총질량이 가벼워진다

| # | D_pw [mm] | d [mm] | D [mm] | T [mm] | B [mm] | C [mm] | α [°] | D_we [mm] | L_we [mm] | 세장비 | z1 [m] | z2 [m] | Z [개] | L_eff [m] | **베어링** [t] | 샤프트 [t] | **합계** [t] | σ_max [MPa] |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| 55 | 4,177 | 3,652 | 4,689 | 560 | 542 | 457 | 27 | 179.3 | 430.3 | 2.400 | 1.0 | 4.5 | 67 | 5.609 | **24.53** | 88.4 | **137.4** | 2,096.5 |
| 56 | 4,164 | 3,640 | 4,676 | 569 | 551 | 465 | 25 | 184.3 | 437.1 | 2.372 | 1.0 | 4.5 | 65 | 5.422 | **24.76** | 87.9 | **137.4** | 2,099.8 |
| 57 | 4,153 | 3,628 | 4,665 | 570 | 552 | 465 | 25 | 184.6 | 437.9 | 2.372 | 1.0 | 4.5 | 65 | 5.417 | **24.77** | 87.2 | **136.7** | 2,099.3 |
| 58 | 4,119 | 3,581 | 4,644 | 585 | 566 | 478 | 25 | 188.0 | 449.5 | 2.391 | 1.0 | 4.5 | 63 | 5.402 | **25.85** | 85.0 | **136.7** | 2,096.4 |
| 59 | 4,265 | 3,721 | 4,797 | 560 | 542 | 457 | 30 | 183.7 | 430.3 | 2.342 | 1.0 | 4.0 | 67 | 5.443 | **25.99** | 82.6 | **134.5** | 2,099.7 |
| 60 | 4,230 | 3,679 | 4,768 | 577 | 558 | 471 | 29 | 184.6 | 442.7 | 2.398 | 1.0 | 4.0 | 66 | 5.327 | **26.91** | 80.7 | **134.5** | 2,099.2 |
| 61 | 3,992 | 3,377 | 4,594 | 607 | 587 | 495 | 30 | 229.2 | 466.0 | 2.033 | 1.0 | 4.5 | 50 | 5.791 | **29.26** | 75.5 | **134.0** | 2,099.6 |
| 62 | 3,987 | 3,371 | 4,590 | 607 | 588 | 496 | 30 | 229.7 | 466.4 | 2.030 | 1.0 | 4.5 | 50 | 5.787 | **29.31** | 75.3 | **133.9** | 2,098.2 |
| 63 | 4,498 | 3,915 | 5,068 | 597 | 578 | 488 | 30 | 198.9 | 458.8 | 2.307 | 1.0 | 3.0 | 65 | 4.579 | **31.23** | 71.1 | **133.5** | 2,099.7 |
| 64 | 4,414 | 3,814 | 5,000 | 623 | 603 | 508 | 30 | 198.9 | 478.1 | 2.404 | 1.0 | 3.0 | 64 | 4.532 | **33.05** | 67.4 | **133.5** | 2,093.1 |

*프론트 전체 64건은 `부록6_NSGA/S3_본최적화/s3_pareto.csv`.*
...
| # | D_pw [mm] | d [mm] | D [mm] | T [mm] | B [mm] | C [mm] | α [°] | D_we [mm] | L_we [mm] | 세장비 | z1 [m] | z2 [m] | Z [개] | L_eff [m] | **베어링** [t] | 샤프트 [t] | **합계** [t] | σ_max [MPa] |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| 1 | 4,493 | 4,086 | 4,891 | 437 | 423 | 357 | 25 | 146.8 | 335.9 | 2.288 | 1.5 | 6.0 | 88 | 6.570 | **15.91** | 143.9 | **175.7** | 2,098.2 |
| 2 | 4,451 | 4,046 | 4,846 | 446 | 431 | 364 | 23 | 147.8 | 342.3 | 2.316 | 1.5 | 6.0 | 87 | 6.365 | **15.97** | 140.9 | **172.9** | 2,098.9 |
| 3 | 4,423 | 4,023 | 4,813 | 480 | 464 | 392 | 15 | 165.5 | 368.4 | 2.226 | 1.5 | 6.0 | 77 | 5.661 | **16.57** | 139.2 | **172.4** | 2,091.2 |
| 4 | 4,417 | 4,016 | 4,807 | 478 | 463 | 390 | 16 | 160.6 | 367.4 | 2.288 | 1.5 | 6.0 | 79 | 5.742 | **16.58** | 139.0 | **172.1** | 2,092.8 |
| 5 | 4,381 | 3,976 | 4,775 | 480 | 465 | 392 | 16 | 163.7 | 368.7 | 2.252 | 1.5 | 6.0 | 77 | 5.731 | **16.66** | 136.1 | **169.4** | 2,098.7 |
| 6 | 4,344 | 3,944 | 4,734 | 494 | 478 | 403 | 15 | 158.0 | 379.6 | 2.403 | 1.5 | 6.0 | 79 | 5.640 | **16.86** | 133.8 | **167.6** | 2,098.8 |
| 7 | 4,364 | 3,936 | 4,782 | 464 | 449 | 379 | 23 | 160.9 | 356.5 | 2.216 | 1.5 | 6.0 | 78 | 6.328 | **17.14** | 133.3 | **167.5** | 2,097.2 |
| 8 | 4,348 | 3,917 | 4,769 | 466 | 451 | 380 | 24 | 158.4 | 358.0 | 2.260 | 1.5 | 6.0 | 79 | 6.412 | **17.32** | 132.0 | **166.7** | 2,096.6 |
| 9 | 4,331 | 3,909 | 4,743 | 482 | 466 | 393 | 21 | 153.9 | 369.8 | 2.403 | 1.5 | 6.0 | 81 | 6.139 | **17.51** | 131.5 | **166.5** | 2,089.4 |
| 10 | 4,281 | 3,861 | 4,690 | 497 | 481 | 406 | 18 | 159.5 | 381.8 | 2.394 | 1.5 | 6.0 | 77 | 5.867 | **17.64** | 128.4 | **163.7** | 2,098.6 |

**총질량 최경량 10건** (프론트 #32 ~ #41) — 프론트 꼬리다. 아래로 갈수록 총질량이 가벼워진다

| # | D_pw [mm] | d [mm] | D [mm] | T [mm] | B [mm] | C [mm] | α [°] | D_we [mm] | L_we [mm] | 세장비 | z1 [m] | z2 [m] | Z [개] | L_eff [m] | **베어링** [t] | 샤프트 [t] | **합계** [t] | σ_max [MPa] |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| 32 | 3,896 | 3,333 | 4,445 | 593 | 574 | 484 | 24 | 216.2 | 455.6 | 2.107 | 1.5 | 6.0 | 52 | 6.217 | **25.55** | 95.6 | **146.7** | 2,093.1 |
| 33 | 3,855 | 3,312 | 4,384 | 630 | 610 | 514 | 19 | 205.8 | 484.0 | 2.352 | 1.5 | 6.0 | 54 | 5.809 | **26.01** | 94.5 | **146.5** | 2,097.7 |
| 34 | 3,864 | 3,287 | 4,427 | 603 | 583 | 492 | 27 | 206.4 | 462.9 | 2.243 | 1.5 | 6.0 | 54 | 6.453 | **26.65** | 93.0 | **146.3** | 2,098.1 |
| 35 | 3,974 | 3,412 | 4,523 | 601 | 581 | 490 | 26 | 197.6 | 461.3 | 2.335 | 1.5 | 5.5 | 58 | 5.921 | **26.72** | 92.5 | **145.9** | 2,095.2 |
| 36 | 3,949 | 3,364 | 4,521 | 611 | 591 | 498 | 26 | 216.6 | 469.0 | 2.165 | 1.5 | 5.5 | 52 | 5.910 | **27.82** | 90.0 | **145.6** | 2,099.2 |
| 37 | 4,062 | 3,486 | 4,625 | 609 | 589 | 497 | 27 | 201.7 | 467.3 | 2.317 | 1.5 | 5.0 | 58 | 5.553 | **28.37** | 88.6 | **145.3** | 2,094.0 |
| 38 | 3,919 | 3,333 | 4,491 | 626 | 606 | 511 | 25 | 213.3 | 480.7 | 2.254 | 1.5 | 5.5 | 53 | 5.811 | **28.48** | 88.2 | **145.2** | 2,091.2 |
| 39 | 3,909 | 3,303 | 4,502 | 627 | 606 | 511 | 26 | 228.8 | 481.2 | 2.103 | 1.5 | 5.5 | 49 | 5.892 | **29.21** | 86.7 | **145.2** | 2,092.0 |
| 40 | 4,036 | 3,418 | 4,640 | 609 | 590 | 497 | 30 | 229.9 | 467.9 | 2.035 | 1.5 | 5.0 | 50 | 5.815 | **29.77** | 85.1 | **144.7** | 2,097.1 |
| 41 | 3,952 | 3,333 | 4,557 | 642 | 622 | 524 | 28 | 218.6 | 493.3 | 2.257 | 1.5 | 5.0 | 52 | 5.586 | **31.19** | 80.9 | **143.3** | 2,099.2 |

*프론트 전체 41건은 `부록6_NSGA/S3_본최적화/s3_pareto.csv`.*
...
> **네 제약이 같은 방향으로 작동한다.** 프론트는 한 방향으로 늘어선 곡선이라 베어링이 무거워질수록 `d`·`D`·`D_we`·`L_we` 가 **함께 커진다.** 따라서 어느 상한을 걸든 잘려나가는 것은 **총질량-최소 쪽 꼬리**이고, 남는 것은 베어링 경량 쪽이다 — 제작 제약은 사실상 **두 목적 사이의 어디까지 갈 수 있는지를 정하는 장치**로 작동한다.

#### 제약별 개별 효과

어느 제약이 병목인지 먼저 본다. 하나씩 단독으로 걸었을 때의 생존 건수다.
...
> **한계값은 아직 지정되지 않았다.** `select_mfg.py` 의 `LIMITS` 에 값을 넣고 다시 돌리면 위 두 표가 채워지고 통과 설계가 `s3_mfg.csv` 로 떨어진다. 근거 없는 숫자를 문서에 남기지 않기 위해 자리표로 둔다.
>
> **통과 설계가 0건이면** 상한 완화 또는 **재최적화**가 필요하다 — 제작 제약을 넣은 채 다시 돌리면 프론트 자체가 제약 안쪽에서 형성되므로, 프론트를 사후에 자르는 것보다 나은 설계가 나올 수 있다.
...
| 8 | **프론트가 피로를 만족하는지** — §6-7 이 루프에서 뺀 근거는 30건 경험칙이고, 최경량 5건의 `D_we` 가 136.8 ~ 146.6 mm 로 P2 Phase 3 최소여유 1.73배 영역과 겹친다 | **S4** |
...
| **R13** | 260803 | §8-5.7 신설 — 베어링 최경량 6건 피로(전원 합격) · 부록 6 신설(NSGA-II) | *(본 개정)*                          |
