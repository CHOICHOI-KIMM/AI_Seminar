...
| # | D_pw | **d** | **D** | α | D_we | L_we | 세장비 | z1 | z2 | Z | L_eff | 베어링 | 샤프트 | **합계** | σ_max |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| 1 | 4,500 | 3,990 | 4,998 | 31 | 170 | 400 | 2.353 | 0.3 | 3.0 | 76 | 5.383 | 23.9 t | 73.7 t | **121.5 t** | 2,090.5 |
| 2 | 4,500 | 3,965 | 5,024 | 31 | 200 | 400 | 2.000 | 0.3 | 3.0 | 65 | 5.384 | 24.7 t | 72.8 t | **122.1 t** | 2,088.0 |
| 3 | 4,200 | 3,597 | 4,790 | 31 | 200 | 475 | 2.375 | 0.5 | 3.0 | 60 | 5.008 | 31.3 t | 59.9 t | **122.6 t** | 2,099.3 |
| 4 | 4,200 | 3,690 | 4,698 | 31 | 170 | 400 | 2.353 | 0.3 | 4.0 | 71 | 6.203 | 22.3 t | 81.1 t | 125.7 t | 2,092.3 |
| 5 | 4,200 | 3,665 | 4,724 | 31 | 200 | 400 | 2.000 | 0.3 | 4.0 | 60 | 6.204 | 23.0 t | 80.0 t | 125.9 t | 2,094.1 |
| 6 | 4,200 | 3,639 | 4,750 | 31 | 230 | 400 | **1.739** | 0.3 | 4.0 | 52 | 6.206 | 23.6 t | 78.9 t | 126.1 t | 2,097.5 |
| 7 | 3,900 | 3,343 | 4,444 | 23 | 200 | 475 | 2.375 | 0.5 | 4.5 | 56 | 5.638 | 26.7 t | 73.9 t | 127.3 t | 2,098.6 |
| 8 | 4,200 | 3,643 | 4,744 | 23 | 200 | 475 | 2.375 | 0.5 | 3.5 | 60 | 4.765 | 28.7 t | 70.2 t | 127.7 t | 2,094.1 |
| 9 | 3,900 | 3,315 | 4,471 | 23 | 230 | 475 | 2.065 | 0.5 | 4.5 | 49 | 5.639 | 27.6 t | 72.7 t | 128.0 t | 2,082.9 |
| 10 | 4,200 | 3,615 | 4,771 | 23 | 230 | 475 | 2.065 | 0.5 | 3.5 | 52 | 4.766 | 29.7 t | 69.2 t | 128.5 t | 2,096.6 |
| 11 | 3,900 | 3,319 | 4,468 | 27 | 200 | 475 | 2.375 | 0.5 | 4.5 | 56 | 5.971 | 28.0 t | 72.9 t | 128.8 t | 2,085.9 |
| 12 | 3,900 | 3,292 | 4,494 | 27 | 230 | 475 | 2.065 | 0.5 | 4.5 | 49 | 5.972 | 28.8 t | 71.7 t | 129.4 t | 2,070.4 |

`d` = bore(= 샤프트 외경) · `D` = 외경. 길이 단위는 mm, α 는 도(°), z1·z2·L_eff 는 m.
...
| 변수 | 수준 | n | 가능해 | 가능률 | σ 최소 | σ 평균 | 최소질량 |
|---|--:|--:|--:|--:|--:|--:|--:|
...
**k 선정** — dt=20 의 ε(k) 에서 **중앙타겟**(`ε_UW·ε_Sys ∈ [0, 3]` 중 `ε_Sys → 1.5`), 창이 없으면 `ε_Sys ≥ 0` 중 최소(보수측), 전부 음수면 `|ε_Sys|` 최소. k 는 0 ~ 3.0 을 0.05 간격으로 훑는다. 부록 4·5 와 동일 규칙이다.
...
| # | α | L_eff [m] | A | B | Y1 | e | C [kN] | C_u [kN] |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|
...
| 1 | L_eff 스크리닝 → 111 DLC × k | 해석식 (numpy) | 설계당 ~1분 · **13분** |
| 2 | MASTA 피로 dt=20 → D30_UW·DW·Sys | MASTA | 설계당 **6.7분** · **87분** |
| 3 | 판정 `D30 ≤ 0.5` · 집계 | — | — |
| 4 | **참값 편향 검증** (최후 수행) | MASTA dt=0.1 | 아래 |

Step 2 의 설계당 소요는 부록 5 실측(111 DLC · 2,646빈 · 403.7 s)에 근거한다.
...
| `screen_eps_map.csv` | k 스윕 전체 (13 × 111 × 61) |
| `fatigue_per_dlc.csv` | 설계 13 × DLC 111 × D30_UW·DW·life·소요 |
| `fatigue_summary.csv` | 설계별 ΣD30_UW·ΣD30_DW·life_Sys·판정 |
| `p2_selfcheck.txt` | 행수·수렴·경고 요약 |
...
| # | D_pw | d | D | α | D_we | L_we | 세장비 | z1 | z2 | 질량 | σ_max | **ΣD30_UW** | **ΣD30_DW** | life_Sys | **판정** |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|:-:|
| 1 | 4,500 | 3,990 | 4,998 | 31 | 170 | 400 | 2.353 | 0.3 | 3.0 | 121.5 t | 2,090.5 | **0.1173** | 0.0049 | 249.5 yr | **합격** |
| 2 | 4,500 | 3,965 | 5,024 | 31 | 200 | 400 | 2.000 | 0.3 | 3.0 | 122.1 t | 2,088.0 | **0.0826** | 0.0035 | 354.2 yr | **합격** |
| 3 | 4,200 | 3,597 | 4,790 | 31 | 200 | 475 | 2.375 | 0.5 | 3.0 | 122.6 t | 2,099.3 | **0.0720** | 0.0036 | 404.3 yr | **합격** |
| 4 | 4,200 | 3,690 | 4,698 | 31 | 170 | 400 | 2.353 | 0.3 | 4.0 | 125.7 t | 2,092.3 | **0.1152** | 0.0033 | 256.3 yr | **합격** |
| 5 | 4,200 | 3,665 | 4,724 | 31 | 200 | 400 | 2.000 | 0.3 | 4.0 | 125.9 t | 2,094.1 | **0.0842** | 0.0024 | 350.6 yr | **합격** |
| 6 | 4,200 | 3,639 | 4,750 | 31 | 230 | 400 | 1.739 | 0.3 | 4.0 | 126.1 t | 2,097.5 | **0.0642** | 0.0019 | 459.7 yr | **합격** |
| 7 | 3,900 | 3,343 | 4,444 | 23 | 200 | 475 | 2.375 | 0.5 | 4.5 | 127.3 t | 2,098.6 | **0.0559** | 0.0024 | 523.6 yr | **합격** |
| 8 | 4,200 | 3,643 | 4,744 | 23 | 200 | 475 | 2.375 | 0.5 | 3.5 | 127.7 t | 2,094.1 | **0.0638** | 0.0042 | 451.7 yr | **합격** |
| 9 | 3,900 | 3,315 | 4,471 | 23 | 230 | 475 | 2.065 | 0.5 | 4.5 | 128.0 t | 2,082.9 | **0.0415** | 0.0018 | 704.4 yr | **합격** |
| 10 | 4,200 | 3,615 | 4,771 | 23 | 230 | 475 | 2.065 | 0.5 | 3.5 | 128.5 t | 2,096.6 | **0.0489** | 0.0032 | 588.5 yr | **합격** |
| 11 | 3,900 | 3,319 | 4,468 | 27 | 200 | 475 | 2.375 | 0.5 | 4.5 | 128.8 t | 2,085.9 | **0.0568** | 0.0019 | 517.5 yr | **합격** |
| 12 | 3,900 | 3,292 | 4,494 | 27 | 230 | 475 | 2.065 | 0.5 | 4.5 | 129.4 t | 2,070.4 | **0.0421** | 0.0015 | 698.1 yr | **합격** |
| 기준선 | 3,331 | 3,055 | 3,600 | 19 | 110 | 238 | 2.154 | 0.5 | 3.0 | 54.4 t | 3,424.2 | **6.9249** | 1.1421 | 3.9 yr | **불합격** |

**전 12건 합격 · 기준선 불합격.** 총 해석 48.9분(설계당 평균 3.8분).

##### 8-3.6.3 판정 결과

| 순위 | # | D_we | α | D_pw | 질량 | σ_max | **ΣD30_UW** | ΣD30_Sys | life_Sys | 기준선 대비 |
|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| 1 | **9** | 230 | 23 | 3,900 | 128.0 t | 2,083 | **0.0415** | 0.0426 | **704.4 yr** | **166.8배** |
| 2 | 12 | 230 | 27 | 3,900 | 129.4 t | 2,070 | 0.0421 | 0.0430 | 698.1 yr | 164.4배 |
| 3 | 10 | 230 | 23 | 4,200 | 128.5 t | 2,097 | 0.0489 | 0.0510 | 588.5 yr | 141.5배 |
| 4 | 7 | 200 | 23 | 3,900 | 127.3 t | 2,099 | 0.0559 | 0.0573 | 523.6 yr | 124.0배 |
| 5 | 11 | 200 | 27 | 3,900 | 128.8 t | 2,086 | 0.0568 | 0.0580 | 517.5 yr | 121.8배 |
| 6 | 8 | 200 | 23 | 4,200 | 127.7 t | 2,094 | 0.0638 | 0.0664 | 451.7 yr | 108.6배 |
| 7 | 6 | 230 | 31 | 4,200 | 126.1 t | 2,098 | 0.0642 | 0.0653 | 459.7 yr | 107.9배 |
| 8 | 3 | 200 | 31 | 4,200 | 122.6 t | 2,099 | 0.0720 | 0.0742 | 404.3 yr | 96.2배 |
| 9 | 2 | 200 | 31 | 4,500 | 122.1 t | 2,088 | 0.0826 | 0.0847 | 354.2 yr | 83.8배 |
| 10 | 5 | 200 | 31 | 4,200 | 125.9 t | 2,094 | 0.0842 | 0.0856 | 350.6 yr | 82.3배 |
| 11 | 4 | 170 | 31 | 4,200 | 125.7 t | 2,092 | 0.1152 | 0.1170 | 256.3 yr | 60.1배 |
| 12 | **1** | 170 | 31 | 4,500 | **121.5 t** | 2,090 | 0.1173 | 0.1202 | 249.5 yr | 59.0배 |
| — | **기준선** | 110.5 | 19 | 3,330.9 | 54.4 t | 3,424 | **6.9249** | 7.7297 | **3.9 yr** | 1.0배 |
