...
<!-- T70:SUMMARY -->
> **수행 중 — 25/40. 아래 값은 잠정이며 완료 시 `compare_70c.py` 가 40건으로 덮어쓴다.**

**25건 대조** (70 °C 완료 25/40). 점도 ν 294.6 → 137.2 mm²/s (-53.4%).
...
| b-베어링최경량 | 5 | 0.2154 ~ 0.3210 | 0.5692 ~ 0.8432 | **2.66배** | 0.59 ~ 0.88배 | **불합격 있음** |

**손상비 2.61 ~ 3.03배 (평균 2.77)** · 70 °C 합격 **10/25** · 50 → 70 에서 뒤집힌 설계 **15건** (a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, b01, b02, b03, b04, b05)
 · 최소 여유는 `b01` 의 **0.59배**(ΣD30_UW 0.8432 · life_Sys 35 yr).

**23건 대조** (70 °C 완료 23/40). 점도 ν 294.6 → 137.2 mm²/s (-53.4%).

| 군 | 건수 | ΣD30_UW 50 °C | ΣD30_UW 70 °C | **손상비** | 여유 70 °C | 판정 |
|---|--:|---|---|--:|--:|:-:|
| a-베어링최경량 | 10 | 0.2460 ~ 0.3039 | 0.6636 ~ 0.8037 | **2.67배** | 0.62 ~ 0.75배 | **불합격 있음** |
| a-총질량최경량 | 10 | 0.0625 ~ 0.1192 | 0.1897 ~ 0.3401 | **2.92배** | 1.47 ~ 2.64배 | 전원 합격 |
| b-베어링최경량 | 3 | 0.2154 ~ 0.3210 | 0.5692 ~ 0.8432 | **2.65배** | 0.59 ~ 0.88배 | **불합격 있음** |

**손상비 2.61 ~ 3.03배 (평균 2.78)** · 70 °C 합격 **10/23** · 50 → 70 에서 뒤집힌 설계 **13건** (a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, b01, b02, b03)
 · 최소 여유는 `b01` 의 **0.59배**(ΣD30_UW 0.8432 · life_Sys 35 yr).

<!-- T70:TABLE -->
판정 기준: **ΣD30_UW ≤ 0.5 ∧ ΣD30_Sys ≤ 0.5** (30년 손상)

| 태그 | 프론트 # | 베어링 [t] | d [mm] | D [mm] | D_we [mm] | L_we [mm] | ΣD30_UW 50 °C | ΣD30_UW 70 °C | **손상비** | life_Sys 50 °C | life_Sys 70 °C | **판정 70 °C** |
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|:-:|
| `a01` | 1 | 13.42 | 4,069 | 4,768 | 140.1 | 334.8 | 0.3039 | **0.7953** | 2.62 | 97 | 37 | **불합격** |
| `a02` | 2 | 13.58 | 4,060 | 4,771 | 146.6 | 334.5 | 0.2775 | **0.7252** | 2.61 | 106 | 41 | **불합격** |
| `a03` | 3 | 13.63 | 4,047 | 4,763 | 136.8 | 330.5 | 0.2981 | **0.8037** | 2.70 | 99 | 37 | **불합격** |
| `a04` | 4 | 13.68 | 4,041 | 4,747 | 140.6 | 339.5 | 0.2933 | **0.7723** | 2.63 | 101 | 38 | **불합격** |
| `a05` | 5 | 13.83 | 4,009 | 4,730 | 140.2 | 336.7 | 0.2788 | **0.7529** | 2.70 | 106 | 39 | **불합격** |
| `a06` | 6 | 13.97 | 3,982 | 4,706 | 147.8 | 343.0 | 0.2595 | **0.6885** | 2.65 | 114 | 43 | **불합격** |
| `a07` | 7 | 14.17 | 3,978 | 4,706 | 147.7 | 345.8 | 0.2530 | **0.6736** | 2.66 | 117 | 44 | **불합격** |
| `a08` | 8 | 14.20 | 3,968 | 4,710 | 141.0 | 337.0 | 0.2655 | **0.7290** | 2.75 | 111 | 40 | **불합격** |
| `a09` | 9 | 14.39 | 3,962 | 4,701 | 147.8 | 346.8 | 0.2460 | **0.6636** | 2.70 | 120 | 44 | **불합격** |
| `a10` | 10 | 14.41 | 3,935 | 4,669 | 147.4 | 352.0 | 0.2482 | **0.6661** | 2.68 | 119 | 44 | **불합격** |
| `a55` | 55 | 24.53 | 3,652 | 4,689 | 179.3 | 430.3 | 0.1158 | **0.3391** | 2.93 | 253 | 86 | 합격 |
| `a56` | 56 | 24.76 | 3,640 | 4,676 | 184.3 | 437.1 | 0.1045 | **0.3087** | 2.95 | 280 | 94 | 합격 |
| `a57` | 57 | 24.77 | 3,628 | 4,665 | 184.6 | 437.9 | 0.1029 | **0.3050** | 2.96 | 284 | 95 | 합격 |
| `a58` | 58 | 25.85 | 3,581 | 4,644 | 188.0 | 449.5 | 0.0944 | **0.2831** | 3.00 | 309 | 103 | 합격 |
| `a59` | 59 | 25.99 | 3,721 | 4,797 | 183.7 | 430.3 | 0.1192 | **0.3401** | 2.85 | 246 | 86 | 합격 |
| `a60` | 60 | 26.91 | 3,679 | 4,768 | 184.6 | 442.7 | 0.1108 | **0.3206** | 2.89 | 264 | 91 | 합격 |
| `a61` | 61 | 29.26 | 3,377 | 4,594 | 229.2 | 466.0 | 0.0634 | **0.1920** | 3.03 | 463 | 152 | 합격 |
| `a62` | 62 | 29.31 | 3,371 | 4,590 | 229.7 | 466.4 | 0.0625 | **0.1897** | 3.03 | 470 | 154 | 합격 |
| `a63` | 63 | 31.23 | 3,915 | 5,068 | 198.9 | 458.8 | 0.0977 | **0.2698** | 2.76 | 296 | 106 | 합격 |
| `a64` | 64 | 33.05 | 3,814 | 5,000 | 198.9 | 478.1 | 0.0901 | **0.2548** | 2.83 | 320 | 113 | 합격 |
| `b01` | 1 | 15.91 | 4,086 | 4,891 | 146.8 | 335.9 | 0.3210 | **0.8432** | 2.63 | 92 | 35 | **불합격** |
| `b02` | 2 | 15.97 | 4,046 | 4,846 | 147.8 | 342.3 | 0.2948 | **0.7871** | 2.67 | 100 | 37 | **불합격** |
| `b03` | 3 | 16.57 | 4,023 | 4,813 | 165.5 | 368.4 | 0.2154 | **0.5692** | 2.64 | 136 | 51 | **불합격** |
| `b04` | 4 | 16.58 | 4,016 | 4,807 | 160.6 | 367.4 | 0.2232 | **0.5968** | 2.67 | 131 | 49 | **불합격** |
| `b05` | 5 | 16.66 | 3,976 | 4,775 | 163.7 | 368.7 | 0.2154 | **0.5783** | 2.68 | 136 | 50 | **불합격** |
